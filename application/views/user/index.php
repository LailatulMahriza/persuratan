...
<!-- NAVBAR -->
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark bg-primary">
          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12">
                         <div>
                              ...
                              <img src="images/kua2.png" alt="" class="img-responsive wc-image">
               ...
               <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         <p>- Surat Izin Magang</p> 
                         <p>- Surat Izin KKN</p> 
                         <p>- Surat Izin PKL</p> 
                         <p>- Surat Izin Penelitian</p> 
                         <p>- Surat Izin Survei</p> 
                         <br><br>
                         <p><h4>Berkas Persyaratan</h4></p>
               ...
               <div class="panel panel-default">
                    <div class="panel-heading">
                         <h4>Tata Cara Pembuatan Surat</h4>
                    </div>

                    <div class="panel-body">
                        <p>1. Siapkan Berkas Anda seperti KTP, Surat Rekomendasi</p>
                        <p>2. Lakukan Register dan Login , isi data diri</p>
                        <p>3. Upload Berkas</p>
                        <p>4. Tunggu untuk verifikasi</p>
                        <p>5. Anda dapat mendownload surat</p>
                    </div>
               </div>
...
<footer class="bg-dark">
    <span class="text-light"><center>Powered by Derisa R.D & Lailatul M <br><a>polinema</a> 2018</center></span>
